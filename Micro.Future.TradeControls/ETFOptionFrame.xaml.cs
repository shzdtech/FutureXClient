...
namespace Micro.Future.UI
{
    ...
    public partial class ETFOptionFrame : UserControl, IUserFrame
    {
        ...
        public Task<bool> LoginAsync(string brokerId, string usernname, string password, string server)
        {
            ...
            _otcETFDataSignIner.SignInOptions.Password = password;
            entries = _otcETFDataSignIner.SignInOptions.FrontServer.Split(new[] { ':' }, StringSplitOptions.RemoveEmptyEntries);
            if (server != null && entries.Length < 2)
        ...
        public void Initialize()
        {
            ...
            marketDataLV.ProductTypeList.Add(ProductType.PRODUCT_ETFOPTION);
            ...
            FastOrderCtl.ProductTypeList.Add(ProductType.PRODUCT_ETFOPTION);
        ...
        private void MenuItem_Click_Contract(object sender, RoutedEventArgs e)
        {
            ...
            marketDataWin.ProductTypeList.Add(ProductType.PRODUCT_ETFOPTION);
